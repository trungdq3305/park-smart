  ...
  const handleNewScan = async (data: ScanData) => {
    ...
    try {
      ...
      const statusRes = await axios.get(
        `${NEST_API_BASE}/parking-sessions/status/check`,
        {
          params: {
  ...
  const handleMainAction = async () => {
    ...
    try {
      if (mode === "CHECK_IN") {
        ...
        await axios.post(
          `${NEST_API_BASE}/parking-lot-sessions/check-in/${CURRENT_PARKING_ID}`,
          {
        ...
        await axios.post(
          `${NEST_API_BASE}/parking-lot-sessions/checkout/confirm`,
          {
