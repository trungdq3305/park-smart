...
export class CreateNotificationDto {
  @ApiProperty({
    description:
      'ID người dùng/đối tượng nhận thông báo (VD: ID của Driver, Operator, Admin)',
  ...
  @ApiProperty({
    ...
    description: 'Vai trò của người nhận thông báo',
    example: 'ADMIN',
  })
  @IsNotEmpty()
  @IsEnum(NotificationRole)
  ...
  @ApiProperty({
    ...
    description: 'Loại thông báo (dùng để phân loại trên FE)',
  })
  @IsNotEmpty()
  @IsEnum(NotificationType)
  type: NotificationType
  ...
  @ApiProperty({
    ...
    example: 'Hệ thống sẽ bảo trì vào 2h sáng mai.',
  })
  @IsNotEmpty()
  @IsString()
  body: string
...
export class NotificationResponseDto {
  ...
  @Expose() // eslint-disable-next-line @typescript-eslint/no-unsafe-return, @typescript-eslint/no-unsafe-call
