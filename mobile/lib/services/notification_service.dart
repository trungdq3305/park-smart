...
class NotificationService {
  ...
  static Future<Map<String, dynamic>> createNotification({
    ...
    required String recipientRole, // e.g., "ADMIN", "DRIVER", "OPERATOR"
    required String type, // e.g., "BOOKING_SUCCESS", "BOOKING_FAILED"
    required String title,
    required String body,
    Map<String, dynamic>? data, // Optional additional data
  }) async {
    try {
      String? token = await _getToken();
      if (token == null) {
      ...
      final uri = Uri.parse('$baseUrl/parking/notifications');
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        final errorBody = response.body;
        print('❌ Error creating notification: $errorBody');
        throw Exception(
          'Failed to create notification: ${response.statusCode} - $errorBody',
        );
      }
    } catch (e) {
      print('❌ Exception in createNotification: $e');
      rethrow;
    }
  }
}
